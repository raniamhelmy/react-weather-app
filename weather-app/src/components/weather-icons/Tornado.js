...
function Tornado() {
    return (
        <div className='tornado-container'>
            <svg version="1.1" id="tornado" className="climacon climacon_tornado" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
              x="0px" y="0px" viewBox="15 15 70 70" enableBackground="new 15 15 70 70" xmlSpace="preserve"  width="230" height="170">
                 <g className="climacon_iconWrap climacon_iconWrap-tornado" fill='#fff'>
                    <g className="climacon_componentWrap climacon_componentWrap-tornado">
                        <path className="climacon_component climacon_component-stroke climacon_component-stroke_tornadoLine"
