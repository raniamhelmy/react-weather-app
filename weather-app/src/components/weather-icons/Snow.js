...
function Snow() {
    return (
        <div className='snow-container'>
            <svg version="1.1" id="cloudSnowAltFill" className="climacon climacon_cloudSnowAltFill" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                x="0px"  y="0px" viewBox="15 15 70 70" enableBackground="new 15 15 70 70" xmlSpace="preserve" width="230" height="170">
                    <g className="climacon_iconWrap climacon_iconWrap-cloudSnowAltFill" fill="#fff">
                        <g className="climacon_componentWrap climacon_componentWrap-snowAlt" >
                            <g className="climacon_component climacon_component climacon_component-snowAlt" >
                                <path className="climacon_component climacon_component-stroke climacon_component-stroke_snowAlt"
                                ...
                                <circle className="climacon_component climacon_component-fill climacon_component-fill_snowAlt"
                                fill="rgb(222,222,222)" cx="50" cy="63.641" r="2"/>
                            </g>
                        </g>
                        <g className="climacon_componentWrap climacon_componentWrap_cloud">
                            ...
                            <path className="climacon_component climacon_component-fill climacon_component-fill_cloud"
